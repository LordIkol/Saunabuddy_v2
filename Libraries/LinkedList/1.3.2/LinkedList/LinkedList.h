...
public:
	LinkedList2();
	LinkedList2(int sizeIndex, T _t); //initiate list size and default value
	virtual ~LinkedList2();
...
template<typename T>
LinkedList2<T>::LinkedList2(int sizeIndex, T _t){
...
template<typename T>
T& LinkedList2<T>::operator[](int index) {
...
template<typename T>
void LinkedList2<T>::sort(int (*cmp)(T &, T &)){
...
template<typename T>
ListNode<T>* LinkedList2<T>::findEndOfSortedString(ListNode<T> *p, int (*cmp)(T &, T &)) {
